...
volatile uint32_t *bcm2835_uart		   = (uint32_t *)MAP_FAILED;
...
uint32_t* bcm2835_regbase(uint8_t regbase)
{
	...
	case BCM2835_REGBASE_BSC1:
	    return (uint32_t *)bcm2835_st;
	case BCM2835_REGBASE_UART:
	    return (uint32_t *)bcm2835_uart;
    }
...
// cwng: additions
static int __bcm2835_initialized__ = 0;
// cwng: additions
...
int bcm2835_init(void)
{
	...
	bcm2835_uart = bcm2835_peripherals + BCM2835_UART_BASE/4;
	return 1; /* Success */
    }

// cwng: additions
	if (__bcm2835_initialized__) {
		return 1;
	}
// cwng: additions
...
// cwng: additions    
		...
		fprintf(stderr, "bcm2835_init: Unable to open %s. \n", BMC2835_RPI2_DT_FILENAME);
		fprintf(stderr, "-- You need to enable device tree using raspi-config under 'Advanced Options'\n");
		return 0;
	}
// cwng: additions    
...
exit:
	...
	bcm2835_close();
// cwng: additions    
	else __bcm2835_initialized__=1;
// cwng: additions    
