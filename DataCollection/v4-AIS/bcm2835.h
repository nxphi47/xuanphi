...
#define BCM2835_UART_BASE               0x201000
...
/*! Base of the UART registers.
  Available after bcm2835_init has been called (as root)
*/
extern volatile uint32_t *bcm2835_uart;
...
typedef enum
{
    ...
    BCM2835_REGBASE_UART = 9,  /*!< Base of the UART registers. */
} bcm2835RegisterBase;
...
/* Defines for GPIO CLOCK
 * CLOCK register offsets from BCM2835_CLOCK_BASE
 */
#define BCM2835_CLOCK_CTL0		0x0070
#define BCM2835_CLOCK_DIV0		0x0074
#define BCM2835_CLOCK_CTL1		0x0078
#define BCM2835_CLOCK_DIV1		0x007c	
#define BCM2835_CLOCK_CTL2		0x0080
#define BCM2835_CLOCK_DIV2		0x0084
...
/* Defines for UART
 * UART registers offsets from BCM2835_UART_BASE
*/
#define BCM2835_UART_DR			0x0000	/*! Data register */
#define BCM2835_UART_RSRECR		0x0004	/*! Receive status register */
#define BCM2835_UART_FR			0x0018	/*! Flag register */
#define BCM2835_UART_IBRD		0x0024	/*! Integer Baudrate divisor */
#define BCM2835_UART_FBRD		0x0028	/*! Fractional Baudrate divisor */
#define BCM2835_UART_LCRH		0x002c	/*! Line Control Register */
#define BCM2835_UART_CR			0x0030	/*! Control register */
#define BCM2835_UART_IFLS		0x0034	/*! Interrupt FIFO Level register */
#define BCM2835_UART_IMSC		0x0038	/*! Interrupt Mask Set Clear register */
#define BCM2835_UART_RIS		0x003c	/*! Raw Interrupt Status */
#define BCM2835_UART_MIS		0x0040	/*! Masked Interrupt Status register */
#define BCM2835_UART_ICR		0x0044	/*! Interrupt Clear register */
#define BCM2835_UART_DMACR		0x0048	/*! DMA Control */
